<template>
  <div class="uk-container uk-margin-small-bottom tabs" >
  	<vk-tabs align="center">
    <vk-tabs-item title="posts"> <post-list> </post-list> </vk-tabs-item>
    <vk-tabs-item title = "media"> </vk-tabs-item>
    <vk-tabs-item title="Review"> </vk-tabs-item>
  </vk-tabs>
  </div>
</template>
